...
import com.men.hospitalsystem.databinding.ActivityOtpVerifyBinding;
...
public class OtpVerifyActivity extends AppCompatActivity {
    ...
    private String gender, email, password, fullName, idNumber, phone, verificationId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gender= getIntent().getStringExtra("selectedRadioButton");
        email= getIntent().getStringExtra("loginEmail");
        password= getIntent().getStringExtra("loginPassword");
        fullName= getIntent().getStringExtra("registrationFullName");
        idNumber= getIntent().getStringExtra("registrationIdNumber");
    ...
    private void storeNewUsersData() {
        ...
        UserHelperClass addNewUser = new UserHelperClass(fullName, idNumber, email, password, phone, gender);
