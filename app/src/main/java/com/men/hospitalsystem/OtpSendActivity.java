...
import com.men.hospitalsystem.databinding.ActivityOtpSendBinding;
...
public class OtpSendActivity extends AppCompatActivity {
    ...
    private void otpSend() {
        ...
        //Get all the values passed from previous activities
        String gender= getIntent().getStringExtra("selectedRadioButton");
        String email= getIntent().getStringExtra("loginEmail");
        String password= getIntent().getStringExtra("loginPassword");
        String fullName= getIntent().getStringExtra("registrationFullName");
        String idNumber= getIntent().getStringExtra("registrationIdNumber");
